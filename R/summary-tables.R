...
#' posterior probability \code{prior_prob} and \code{post_probs},
...
ensemble_summary_table <- function(models, parameters, title = NULL, footnotes = NULL, warnings = NULL, remove_spike_0 = TRUE, short_name = FALSE){
  ...
  for(i in seq_along(models)){
    ...
    check_list(model_inference, "model:inference", check_names = c("m_number", "marglik", "prior_prob", "post_probs", "inclusion_BF"), allow_other = TRUE, all_objects = TRUE)
    ...
    check_real(model_inference[["post_probs"]],   "model_inference:post_probs",   lower = 0, upper = 1)
...
model_summary_table <- function(model, model_description = NULL, title = NULL, footnotes = NULL, warnings = NULL, remove_spike_0 = TRUE, short_name = FALSE){
  ...
  summary_values <- c(
    ...
    .format_column(model_inference[["post_probs"]],   "probability"),
