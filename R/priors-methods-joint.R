...
.is_prior_default_range   <- function(prior){
  switch(
    ...
    "lognormal" = prior$truncation[["lower"]] == 0                  & is.infinite(prior$truncation[["upper"]]),
    "t"         = is.infinite(prior$truncation[["lower"]])          & is.infinite(prior$truncation[["upper"]]),
    "gamma"     = prior$truncation[["lower"]] == 0                  & is.infinite(prior$truncation[["upper"]]),
    "invgamma"  = prior$truncation[["lower"]] == 0                  & is.infinite(prior$truncation[["upper"]]),
    ...
    "beta"      = prior$truncation[["lower"]] == 0                  & prior$truncation[["upper"]] == 1,
    "bernoulli" = prior$truncation[["lower"]] == 0                  & prior$truncation[["upper"]] == 1,
    "exp"       = prior$truncation[["lower"]] == 0                  & is.infinite(prior$truncation[["upper"]]),
    "uniform"   = prior$truncation[["lower"]] == prior$parameters[["a"]] &
      prior$truncation[["upper"]] == prior$parameters[["b"]],
    "point"     = TRUE,
    "mpoint"          = TRUE,
    "dirichlet"       = TRUE,
    "weightfunction"  = TRUE,
