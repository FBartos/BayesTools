...
As before, we find absence of evidence for either of the hypotheses, $\text{BF}_{10} = 1.174$, with posterior probability of $P(\mathcal{M}_{1} \mid \text{data}) = 0.540$.
